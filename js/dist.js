 ...
 * Build: http://modernizr.com/download/#-inlinesvg-svg-touch-shiv-cssclasses-teststyles-prefixes-unicode-load
 */
;
...
(function() {
  ...
  $.getJSON(window.dataPath, function(data) {
    var arc, collide, dataByFaction, drawRepresentatives, factions, filterData, force, g, initializeRepPositions, inspector, minSumPerSeat, node, parliament, pie, renderInterval, renderStart, repRadius, repRadiusScaleFactor, seats, seatsPie, svg, tick, tickI, totalSeats;
    data = data.data;
    window._data = _(data);
